...
function Timeline() {
    ...
    return (
        ...
        //                 <p>
        //                     On Thursday, 13<sup>th</sup> September, 2023,
        //                     <br />
                    ...
                    <>
                        <div className="row">
                            <div className="col-lg-6 left" data-aos="fade-down">
                                <h1>Shukrana</h1>
                                <p>
                                    On Saturday, 16<sup>th</sup> September,
                                    2023.
                                    <br />
                                    01<sup>st</sup> Rabi-ul-Awwal, 1445 Hijri,
                                    <br />
                                    Time: 08:30 PM.
                                </p>
                            </div>
                        ...
                        <div className="row">
                            ...
                            >
                                <h1>Nikaah</h1>
                                <p>
                                    On Sunday, 17<sup>th</sup> September, 2023,
                                    <br />
                                    02<sup>nd</sup> Rabi-ul-Awwal, 1445 Hijri,
                                    <br /> Time: 12:45 PM.
                                </p>
                        ...
                        <div className="row">
                            ...
                            >
                                ...
                                <p>
                                    On Monday, 18<sup>th</sup> September, 2023,
                                    <br />
                                    03<sup>rd</sup> Rabi-ul-Awwal, 1445 Hijri,
                                    <br />
                                    Time: 02:00 PM.
                                </p>
        ...
        //                         <h1>Nikaah</h1>
        //                         <p>
        //                             On Saturday, 24<sup>th</sup> September, 2023,
        //                             <br />
        //                             06<sup>th</sup> Rabi-ul-Awwal, 1445 Hijri,
        //                             <br />
        //                             Time: 11:45 AM.
        //                         </p>
        ...
        //                         <h1>Valima</h1>
        //                         <p>
        //                             On Sunday, 25<sup>th</sup> September, 2023,
        //                             <br />
        //                             07<sup>th</sup> Rabi-ul-Awwal, 1445 Hijri,
        //                             <br />
        //                             Time: 01:00 PM.
        //                         </p>
        //                         <h2>Venue:</h2>
